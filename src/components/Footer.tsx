        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12 border-b border-slate-100">
          <div className="lg:col-span-4 space-y-4">
            <a href="/#home" className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#7C5CFC] to-[#9B82FC] flex items-center justify-center text-white font-extrabold text-base shadow-md shadow-purple-500/20">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              {navigation.map((item) => (
                <li key={item.id}>
                  <a href={`/${item.href}`.replace(/^\/#/, "/#")} className="text-slate-500 hover:text-[#7C5CFC] transition-colors font-medium">
            ...
            <ul className="space-y-2.5 text-xs">
              ...
              <li>
                <a
                  ...
                  className="text-slate-600 hover:text-[#7C5CFC] flex items-center gap-2 font-medium transition-colors"
                >
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 pr-10 rounded-xl bg-slate-50 border border-slate-200 text-xs focus:bg-white focus:border-[#7C5CFC] focus:outline-none transition-all"
                  required
                />
                <button
                  type="submit"
                  className="absolute right-1.5 top-1/2 -translate-y-1/2 w-7 h-7 rounded-lg bg-[#7C5CFC] hover:bg-[#6842f5] text-white flex items-center justify-center transition-colors shadow-xs"
