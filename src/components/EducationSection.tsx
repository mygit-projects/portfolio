...
const accentMap = {
  purple: {
    card: "border-purple-200/90 shadow-purple-500/5 hover:border-[#5B3DE0]",
    icon: "bg-purple-50 text-[#5B3DE0] group-hover:bg-[#5B3DE0] group-hover:text-white",
    badge: "bg-purple-100 text-[#5B3DE0]",
    label: "text-[#5B3DE0]",
    headingHover: "group-hover:text-[#5B3DE0]",
  },
  indigo: {
    card: "border-slate-200 hover:border-[#5B3DE0]",
  ...
  slate: {
    card: "border-slate-200 hover:border-[#5B3DE0]",
    icon: "bg-slate-100 text-slate-700 group-hover:bg-[#5B3DE0] group-hover:text-white",
...
const certAccentMap = {
  ...
  purple: {
    ...
    icon: "bg-purple-50 text-[#5B3DE0] border-purple-200",
    badge: "bg-purple-100 text-[#5B3DE0]",
    label: "text-[#5B3DE0]",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-1.5 bg-white p-1.5 rounded-2xl border border-slate-200 shadow-xs self-start md:self-end">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                activeTab === "degrees" ? "bg-[#5B3DE0] text-white shadow-sm" : "text-slate-600 hover:text-slate-900"
              }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                activeTab === "certifications" ? "bg-[#5B3DE0] text-white shadow-sm" : "text-slate-600 hover:text-slate-900"
              }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                activeTab === "languages" ? "bg-[#5B3DE0] text-white shadow-sm" : "text-slate-600 hover:text-slate-900"
              }`}
            >
                ...
                >
                  <div>
                    ...
                    <div className="space-y-1.5 pt-4 border-t border-slate-100">
                      <div className="text-[11px] font-black text-slate-600 uppercase tracking-wider mb-2">{item.modulesLabel}</div>
        ...
        {activeTab === "languages" && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {languages.map((lang, idx) => (
              ...
              >
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-purple-50 text-[#5B3DE0] flex items-center justify-center mb-5 border border-purple-100">
                    <Globe2 className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-black text-slate-900 mb-1">{lang.language}</h3>
                  <p className="text-xs font-extrabold text-[#5B3DE0] uppercase tracking-wider mb-3">{lang.proficiency}</p>
                ...
                <div className="pt-4 mt-6 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-slate-500">
                  ...
                  <span className="text-emerald-800">100% Fluent</span>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mt-12 bg-white rounded-3xl p-6 sm:p-8 border border-purple-200/80 shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-[#5B3DE0] text-white flex items-center justify-center shrink-0 shadow-md shadow-purple-500/20">
          ...
          <a
            href="#contact"
            className="px-5 py-3 rounded-2xl bg-purple-50 hover:bg-[#5B3DE0] text-[#5B3DE0] hover:text-white text-xs font-black transition-all border border-purple-200 shadow-xs shrink-0"
          >
